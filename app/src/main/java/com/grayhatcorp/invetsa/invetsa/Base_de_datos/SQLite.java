...
public class SQLite extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int versionAnte, int versionNue) {
        ...
        db.execSQL("create table puntuacion(" +
                ...
                "primary key(id,id_sistema)" +
                ")");
        db.execSQL("drop table if exists detalle_puntuacion");
        db.execSQL("create table detalle_puntuacion(" +
                "id integer not null," +
                "nombre varchar(50)," +
                "estado int," +
                ...
                "primary key(id,id_puntuacion,id_sistema)" +
                ")");
        db.execSQL("drop table if exists peso");
        db.execSQL("create table peso(" +
                "id integer not null," +
                "peso_corporal decimal(2,2)," +
                "peso_bursa decimal(2,2)," +
                ...
                "primary key(id,id_sistema)" +
                ")");
        db.execSQL("drop table if exists hoja_verificacion");
        db.execSQL("create table hoja_verificacion(" +
                "id integer not null," +
                "fecha text," +
                "hora_ingreso text," +
                ...
                "estado integer default 0"+
                ")");
        db.execSQL("drop table if exists vacunador");
        db.execSQL("create table vacunador(" +
                "id integer primary key not null," +
                "nombre varchar(50)" +
                ")");
        db.execSQL("drop table if exists accion");
        db.execSQL("create table accion(" +
                "id integer  not null," +
                "nombre varchar(50)," +
                "id_hoja_verificacion integer," +
                ...
                "primary key(id,id_hoja_verificacion)"+
                ")");
        db.execSQL("drop table if exists detalle_accion");
        db.execSQL("create table detalle_accion(" +
                "id integer  not null," +
                "esperado varchar(50)," +
                "encontrado varchar(50)," +
                ...
                "primary key(id,id_accion,id_hoja_verificacion)"+
                ")");
        db.execSQL("drop table if exists mantenimiento_limpieza");
        db.execSQL("create table mantenimiento_limpieza(" +
                "id integer not null," +
                "nro_maquina integer," +
                "irregularidades integer," +
                ...
                "primary key(id,id_vacunador,id_hoja_verificacion)"+
                ")");
        db.execSQL("drop table if exists control_indice");
        db.execSQL("create table control_indice(" +
                "id integer not null," +
                "nro_pollos_vacunado integer default 0," +
                "puntaje integer default 0," +
                ...
                "primary key(id,id_vacunador,id_hoja_verificacion)"+
                ")");
        db.execSQL("drop table if exists manipulacion_dilucion");
        db.execSQL("create table manipulacion_dilucion(" +
                "id integer  not null," +
                "descripcion text," +
                "puntaje decimal(2,2)," +
        ...
        db.execSQL("drop table if exists viabilidad_celular");
        db.execSQL("create table viabilidad_celular(" +
                "id integer not null," +
                "antibiotico text," +
                "dosis text," +
                ...
                "primary key(id,id_hoja_verificacion)" +
                ")");
        db.execSQL("drop table if exists linea_genetica");
        db.execSQL("create table linea_genetica(" +
                "id integer not null," +
                "descripcion text," +
                "cobb text," +
                ...
                "primary key(id,id_hoja_verificacion)" +
                ")");
        db.execSQL("drop table if exists indice_eficiencia");
        db.execSQL("create table indice_eficiencia(" +
                "id integer primary key not null," +
                "puntaje decimal(13,2)," +
                "minimo decimal(13,2)," +
