...
public class MaquinaSpravac extends AppCompatActivity implements View.OnClickListener {
    ...
    //private final String id_maquina="";

    MultiAutoCompleteTextView autoMaquina;      //Agregado para soportar varias maquinas
    ...
    private void guardar_formulario() {
        ...
        if(sw_verificar_datos) {
            ...
            sw_se = guardar_servicio_mantenimiento(id_servicio, fecha.getText().toString(), hora_ingreso.getText().toString(), hora_salida.getText().toString(), codigo, revision, DIRECCION_FIRMA_JEFE, DIRECCION_FIRMA_INVETSA, id_maquina, String.valueOf(id_tecnico), String.valueOf(id_compania), "SPRAVAC",DIRECCION_FOTO_JEFE,
...
//-----------------------HASTA AQUI CODIGO PARA LOS DIALOGOS PARA HORA - FECHA------------------------
    ...
    private void cargar_maquina_en_la_lista()
    {
        ...
        autoMaquina.setTokenizer(new MultiAutoCompleteTextView.CommaTokenizer());   //Agregado para que soporte multiples maquinas
    }
